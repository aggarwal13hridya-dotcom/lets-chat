...
import { getStorage } from "firebase/storage"; // <--- ADDED: Import Firebase Storage
...
const storage = getStorage(app); // <--- ADDED: Initialize Firebase Storage

// export { auth, provider, db }; // Old Export
export { auth, provider, db, storage }; // <--- FIXED: Exporting the Storage service
export default app;